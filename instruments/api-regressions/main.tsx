...
function Focus(){
  ...
  return <><SurfaceCanvas id="focus" pointerMode="surfaces" frameloop="demand" flat style={{position:'fixed',inset:0}}/><Surface.Root surface={surface} canvas="focus" inScene={inScene} timing={{settleMs:0,durationMs:1}}><Surface.HTML><form style={{margin:40,width:300,height:150,background:'white'}}><label>Retained field <input id="focus-input" defaultValue="preserved focus"/></label></form></Surface.HTML><Surface.Mesh/></Surface.Root></>
}
