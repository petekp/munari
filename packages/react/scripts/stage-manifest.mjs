...
// `@petepetrash/munari` through the workspace with no alias standing in for the
...
//
//   npm run build -w @petepetrash/munari && npm publish packages/react/dist
//
...
// `@petepetrash/munari/style.css` is declared surface and is not in the entry graph,
