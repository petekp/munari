  ...
  return (
    <section className="home-section home-start-section" id="get-started" aria-labelledby="start-title">
      <div className="home-section-heading">
        ...
        <p>Write your content in React. A <code>Surface</code> gives it a page presentation and a mesh. Change <code>renderIn</code> to choose where it appears.</p>
      </div>
      <div className="home-start-grid">
        <div className="home-start-copy">
          ...
          <p>The page and captured content are separate React instances. This example keeps their shared count in the parent.</p>
