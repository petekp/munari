    ...
    <section className="home-section home-support-section" id="support" aria-labelledby="support-title">
      ...
      <div className="home-support-detail">
        ...
        <details className="home-disclosure">
          ...
          <p>The page and captured content render as separate React instances. Keep shared values in their parent, use controlled inputs, and account for effects that should run only once.</p>
