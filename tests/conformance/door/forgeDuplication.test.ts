// The door duplication test — the forge brand lives in the global
// symbol registry, so two module instances recognize each other's
// forgeries; a module-local Symbol() must fail exactly this.
//
...
// isForgedEvent, and every provenance guard silently inverts. forge()
...
// except forge). This contract pins the property behaviorally, since
