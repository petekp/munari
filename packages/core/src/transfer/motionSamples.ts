...
// ~120/s on an open popover — and a root-level translate slides pixels
// *inside* the slab and clips at its edge, which reads as a texture
// glitch rather than a panel moving.
//
// So the conductor pauses each CSS animation and asks the style engine
// what it *would* have painted at a series of times (pause → set
// currentTime → getComputedStyle returns the eased, interpolated value).
// That turns a declarative `animate-in fade-in-0 zoom-in-95
